...
BOOTPATCHDIR="u-boot-axera/llm"
BOOTCONFIG="AX630C_m5stack_LLM_module_defconfig"


LINUXCONFIG="linux-ax630c-llm"
LINUXDTS="m5stack-ax630c-module-llm"


CUSTOM_ROOTFS_SCRIPT=axera-image-llm.sh


# compile: ./compile.sh build BOARD=m5stack-ax630c-llm BRANCH=edge BUILD_DESKTOP=no BUILD_MINIMAL=yes KERNEL_CONFIGURE=no RELEASE=trixie